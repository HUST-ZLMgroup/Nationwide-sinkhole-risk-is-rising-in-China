...
def groundwater_wtd(
    ...
    hist_store = os.path.join(
        gw_root,
        "historical",
        "wtd_annual_1960_2014_historical_ensemble.zarr",
    )
    ...
    future_windows = {
        "WTD_2020_2040": [2020, 2030, 2040],
        "WTD_2040_2060": [2040, 2050, 2060],
        "WTD_2060_2080": [2060, 2070, 2080],
        "WTD_2080_2100": [2080, 2090, 2100],
    }
    ...
    hist_map = _extract_wtd_from_zarr(
        ...
        hist_years_store,
        sinkhole_position,
        label_prefix="[GroundwaterWTD-HIST]",
    )
    year_values.update(hist_map)

    ssp_map = _extract_wtd_from_zarr(
        ssp_store,
        ssp_years_store,
        sinkhole_position,
        label_prefix="[GroundwaterWTD-SSP]",
    )
    ...
    hist_output_path = os.path.join(
        historical_folder_path,
        "GroundwaterWTD_historical_2000_2010_2020.csv",
    )
    ...
    future_output_path = os.path.join(
        future_ssp_folder_path,
        f"GroundwaterWTD_future_{ssp}.csv",
    )
